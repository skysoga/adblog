<template>
  <div class="container">
  	<h1>第一个</h1>
    <lg-calendar :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder"></lg-calendar>
    {{value}}
    <div class="text-right">
    <h1>第2个</h1>
       <lg-calendar :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2"></lg-calendar>
    </div>
    <h1>第3个</h1>
    <div style="height: 300px;">
      <lg-calendar :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :has-input="false" :on-day-click="onDayClick1"></lg-calendar>
      <p>{{date1}}</p>
    </div>
    <h1>第4个</h1>
    <div style="height: 300px;">
    <!-- range-bus example -->
      <lg-calendar :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :range-bus="getBus" :range-status="1"></lg-calendar>
       <lg-calendar :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :range-bus="getBus" :range-status="2"></lg-calendar>
    </div>

<h1>第5个</h1>
    <div style="height: 300px;">
      <lg-calendar :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :has-input="false" :on-day-click="onDayClick2" :special-days="_dateMap">
      </lg-calendar>
      <p>{{date2}}</p>
    </div>
    <h1>第6个</h1>
    <div style="height: 600px;">
      <lg-calendar class="event-lg-calendar" :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :has-input="false" :on-day-click="onDayClick3" :change-pane="changePane">
    ...
    <h1>第7个</h1>
    <div style="height: 600px;">
      <lg-calendar class="event-lg-calendar" :value="value" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :has-input="false" :on-day-click="onDayClick4" :change-pane="changePane2">
